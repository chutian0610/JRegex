...
class NFATest {
    ...
    void parse01() throws IOException {
        ...
        log.info("\n================== NFA ================\n{}======================================", nfaStr);
        Assertions.assertEquals("ns_0(0)-->|'a'|ns_1(1)\n" + "ns_1(1)-->|ϵ|ns_2(2)\n" + "ns_2(2)-->|'b'|ns_3((3))\n", nfaStr);
    }
    ...
    void parse02() throws IOException {
        ...
        String nfaStr = nfa.toString();
        log.info("\n================== NFA ================\n{}======================================", nfaStr);
        Assertions.assertEquals("ns_0(0)-->|ϵ|ns_1(1)\n" + "ns_1(1)-->|'a'|ns_2(2)\n" + "ns_2(2)-->|ϵ|ns_5((5))\n" + "ns_0(0)-->|ϵ|ns_3(3)\n" + "ns_3(3)-->|'b'|ns_4(4)\n" + "ns_4(4)-->|ϵ|ns_5((5))\n", nfaStr);
    }
    ...
    @Test
    void parse04() throws IOException {
    ...
    @Test
    void toDFA01() throws IOException {
        RegexExp regexExpression = RegexParser.parse("ab");
        NFA nfa = NFA.buildNFA(regexExpression);
        log.info("\n================== NFA ================\n{}======================================", nfa);
        DFA dfa = nfa.toDFA();
    ...
    @Test
    void toDFA02() throws IOException {
        RegexExp regexExpression = RegexParser.parse("a|b");
        NFA nfa = NFA.buildNFA(regexExpression);
        log.info("\n================== NFA ================\n{}======================================", nfa);
        DFA dfa = nfa.toDFA();
    ...
    @Test
    void toDFA03() throws IOException {
        RegexExp regexExpression = RegexParser.parse("a*b");
        NFA nfa = NFA.buildNFA(regexExpression);
        log.info("\n================== NFA ================\n{}======================================", nfa);
        DFA dfa = nfa.toDFA();
    ...
    @Test
    void toDFA04() throws IOException {
        RegexExp regexExpression = RegexParser.parse("(a|b)*abb");
        NFA nfa = NFA.buildNFA(regexExpression);
        log.info("\n================== NFA ================\n{}======================================", nfa);
        DFA dfa = nfa.toDFA();
